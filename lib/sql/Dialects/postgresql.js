...
exports.escapeId = function () {
  ...
  var escaped = Array.prototype.slice.apply(arguments).map(function (el) {
    if (typeof el == "object") {
...
exports.escapeVal = function (val, {timezone, inArray}) {
	...
	if (Array.isArray(val)) {
		...
		return "'{" + val.map(exports.escapeVal.bind(this, {timezone: timezone, inArray: true})).join(", ") + "}'";
	}
