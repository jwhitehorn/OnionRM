...
exports.connect = function (opts, profiler, cb) {
...
ORM.prototype.begin = function (cb) {
	this.driver.begin(cb);

	return this;
};
ORM.prototype.commit = function (cb) {
	this.driver.commit(cb);

	return this;
};
ORM.prototype.rollback = function (cb) {
	this.driver.rollback(cb);
