...
var pg      = require("p" + "g"); //silly hack to keep browserify out of here.
try{
  pg = pg.native;
}catch(e){}
...
function Driver(config, connection, opts) {
  ...
  if ((typeof window !== "undefined" && window !== null ? window.pg : void 0) != null) {
    pg = window.pg; //HACK: to sideload pg
  }
